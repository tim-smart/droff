...
export const factory =
  ...
  () => {
    ...
    // Response helpers
    const respond =
      interactionRespond<APIInteractionResponseChannelMessageWithSource>(
        rest,
        InteractionResponseType.ChannelMessageWithSource,
      );
    const respondDeferred =
      interactionRespond<APIInteractionResponseDeferredChannelMessageWithSource>(
        rest,
