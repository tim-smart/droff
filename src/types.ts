...
export type ChannelMap = Record<Snowflake, Channel>;
export type MemberMap = Record<Snowflake, GuildMember>;
export type RoleMap = Record<Snowflake, Role>;
export type UserMap = Record<Snowflake, User>;
...
export function createRoutes<O = any>(
  ...
  return {
    ...
    listGuildEmojis: (guildId: string, options?: O) =>
      fetch<Emoji[], any>({
        method: "GET",
    ...
    getGuildEmoji: (guildId: string, emojiId: string, options?: O) =>
      fetch<Emoji, any>({
        method: "GET",
    ...
    createGuildEmoji: (
      ...
      fetch<Emoji, Partial<CreateGuildEmojiParams>>({
        method: "POST",
        url: `/guilds/${guildId}/emojis`,
        params,
        options,
    ...
    modifyGuildEmoji: (
      ...
      fetch<Emoji, Partial<ModifyGuildEmojiParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}/emojis/${emojiId}`,
        params,
        options,
    ...
    deleteGuildEmoji: (guildId: string, emojiId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/guilds/${guildId}/emojis/${emojiId}`,
        options,
    ...
    createGuildFromGuildTemplate: (
      ...
      fetch<Guild, Partial<CreateGuildFromGuildTemplateParams>>({
        method: "POST",
        url: `/guilds/templates/${templateCode}`,
        params,
        options,
    ...
    getGuildTemplates: (guildId: string, options?: O) =>
      fetch<GuildTemplate[], any>({
        method: "GET",
    ...
    createGuildTemplate: (
      ...
      fetch<GuildTemplate, Partial<CreateGuildTemplateParams>>({
        method: "POST",
        url: `/guilds/${guildId}/templates`,
        params,
        options,
    ...
    syncGuildTemplate: (guildId: string, templateCode: string, options?: O) =>
      fetch<GuildTemplate, any>({
        method: "PUT",
    ...
    modifyGuildTemplate: (
      ...
      fetch<GuildTemplate, Partial<ModifyGuildTemplateParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}/templates/${templateCode}`,
        params,
        options,
    ...
    deleteGuildTemplate: (guildId: string, templateCode: string, options?: O) =>
      fetch<GuildTemplate, any>({
        method: "DELETE",
        url: `/guilds/${guildId}/templates/${templateCode}`,
        options,
    ...
    getUser: (userId: string, options?: O) =>
      fetch<User, any>({
        method: "GET",
        url: `/users/${userId}`,
        options,
    ...
    modifyCurrentUser: (
      ...
      fetch<User, Partial<ModifyCurrentUserParams>>({
        method: "PATCH",
        url: `/users/@me`,
        params,
        options,
    ...
    getCurrentUserGuilds: (
      ...
      fetch<Guild[], Partial<GetCurrentUserGuildParams>>({
        method: "GET",
        url: `/users/@me/guilds`,
        params,
        options,
    ...
    leaveGuild: (guildId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
    ...
    createDm: (params: Partial<CreateDmParams>, options?: O) =>
      fetch<Channel, Partial<CreateDmParams>>({
        method: "POST",
    ...
    createGroupDm: (params: Partial<CreateGroupDmParams>, options?: O) =>
      fetch<Channel, Partial<CreateGroupDmParams>>({
        method: "POST",
        url: `/users/@me/channels`,
        params,
        options,
    ...
    getUserConnections: (options?: O) =>
      fetch<Connection[], any>({
        method: "GET",
    ...
    getGuildAuditLog: (
      ...
      fetch<AuditLog, Partial<GetGuildAuditLogParams>>({
        method: "GET",
    ...
    createWebhook: (
      ...
      fetch<Webhook, Partial<CreateWebhookParams>>({
        method: "POST",
    ...
    getChannelWebhooks: (channelId: string, options?: O) =>
      fetch<Webhook[], any>({
        method: "GET",
        url: `/channels/${channelId}/webhooks`,
        options,
    ...
    getGuildWebhooks: (guildId: string, options?: O) =>
      fetch<Webhook[], any>({
        method: "GET",
    ...
    getWebhook: (webhookId: string, options?: O) =>
      fetch<Webhook, any>({
        method: "GET",
    ...
    modifyWebhook: (
      ...
      fetch<Webhook, Partial<ModifyWebhookParams>>({
        method: "PATCH",
        url: `/webhooks/${webhookId}`,
        params,
        options,
    ...
    deleteWebhook: (webhookId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/webhooks/${webhookId}`,
        options,
    ...
    executeWebhook: (
      ...
      fetch<any, Partial<ExecuteWebhookParams>>({
        method: "POST",
        url: `/webhooks/${webhookId}/${webhookToken}`,
        params,
        options,
    ...
    executeSlackCompatibleWebhook: (
      webhookId: string,
      webhookToken: string,
      params: Partial<ExecuteSlackCompatibleWebhookParams>,
      options?: O,
    ) =>
      fetch<any, Partial<ExecuteSlackCompatibleWebhookParams>>({
        method: "POST",
    ...
    executeGitHubCompatibleWebhook: (
      webhookId: string,
      webhookToken: string,
      params: Partial<ExecuteGitHubCompatibleWebhookParams>,
      options?: O,
    ) =>
      fetch<any, Partial<ExecuteGitHubCompatibleWebhookParams>>({
        method: "POST",
    ...
    editWebhookMessage: (
      ...
      fetch<Message, Partial<EditWebhookMessageParams>>({
        method: "PATCH",
        url: `/webhooks/${webhookId}/${webhookToken}/messages/${messageId}`,
        params,
        options,
    ...
    getGlobalApplicationCommands: (applicationId: string, options?: O) =>
      fetch<ApplicationCommand[], any>({
        method: "GET",
    ...
    createGlobalApplicationCommand: (
      ...
      fetch<ApplicationCommand, Partial<CreateGlobalApplicationCommandParams>>({
        method: "POST",
        url: `/applications/${applicationId}/commands`,
        params,
        options,
    ...
    editGlobalApplicationCommand: (
      ...
      fetch<ApplicationCommand, Partial<EditGlobalApplicationCommandParams>>({
        method: "PATCH",
        url: `/applications/${applicationId}/commands/${commandId}`,
        params,
        options,
    ...
    createGuildApplicationCommand: (
      ...
      fetch<ApplicationCommand, Partial<CreateGuildApplicationCommandParams>>({
        method: "POST",
        url: `/applications/${applicationId}/guilds/${guildId}/commands`,
        params,
        options,
    ...
    editGuildApplicationCommand: (
      ...
      fetch<ApplicationCommand, Partial<EditGuildApplicationCommandParams>>({
        method: "PATCH",
        url: `/applications/${applicationId}/guilds/${guildId}/commands/${commandId}`,
        params,
        options,
    ...
    createInteractionResponse: (
      ...
      fetch<any, Partial<InteractionResponse>>({
        method: "POST",
    ...
    getGuildApplicationCommandPermissions: (
      ...
      fetch<GuildApplicationCommandPermission[], any>({
        method: "GET",
    ...
    editApplicationCommandPermissions: (
      ...
      fetch<any, Partial<EditApplicationCommandPermissionParams>>({
        method: "PUT",
        url: `/applications/${applicationId}/guilds/${guildId}/commands/${commandId}/permissions`,
        params,
        options,
    ...
    batchEditApplicationCommandPermissions: (
      ...
      fetch<any, Partial<GuildApplicationCommandPermission[]>>({
        method: "PUT",
        url: `/applications/${applicationId}/guilds/${guildId}/commands/permissions`,
        params,
        options,
    ...
    createGuild: (params: Partial<CreateGuildParams>, options?: O) =>
      fetch<Guild, Partial<CreateGuildParams>>({
        method: "POST",
        url: `/guilds`,
        params,
        options,
    ...
    getGuild: (guildId: string, params: Partial<GetGuildParams>, options?: O) =>
      fetch<Guild, Partial<GetGuildParams>>({
        method: "GET",
        url: `/guilds/${guildId}`,
        params,
        options,
    ...
    getGuildPreview: (guildId: string, options?: O) =>
      fetch<GuildPreview, any>({
        method: "GET",
    ...
    modifyGuild: (
      ...
      fetch<Guild, Partial<ModifyGuildParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}`,
        params,
        options,
    ...
    deleteGuild: (guildId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/guilds/${guildId}`,
        options,
    ...
    getGuildChannels: (guildId: string, options?: O) =>
      fetch<Channel[], any>({
        method: "GET",
    ...
    createGuildChannel: (
      ...
      fetch<Channel, Partial<CreateGuildChannelParams>>({
        method: "POST",
        url: `/guilds/${guildId}/channels`,
        params,
        options,
    ...
    modifyGuildChannelPositions: (
      ...
      fetch<any, Partial<ModifyGuildChannelPositionParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}/channels`,
        params,
        options,
    ...
    getGuildMember: (guildId: string, userId: string, options?: O) =>
      fetch<GuildMember, any>({
        method: "GET",
    ...
    listGuildMembers: (
      ...
      fetch<GuildMember[], Partial<ListGuildMemberParams>>({
        method: "GET",
    ...
    searchGuildMembers: (
      ...
      fetch<GuildMember[], Partial<SearchGuildMemberParams>>({
        method: "GET",
    ...
    addGuildMember: (
      ...
      fetch<GuildMember, Partial<AddGuildMemberParams>>({
        method: "PUT",
        url: `/guilds/${guildId}/members/${userId}`,
        params,
        options,
    ...
    modifyGuildMember: (
      ...
      fetch<GuildMember, Partial<ModifyGuildMemberParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}/members/${userId}`,
        params,
        options,
    ...
    modifyCurrentUserNick: (
      ...
      fetch<any, Partial<ModifyCurrentUserNickParams>>({
        method: "PATCH",
    ...
    removeGuildMember: (guildId: string, userId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/guilds/${guildId}/members/${userId}`,
        options,
    ...
    getGuildBans: (guildId: string, options?: O) =>
      fetch<Ban[], any>({
        method: "GET",
    ...
    getGuildBan: (guildId: string, userId: string, options?: O) =>
      fetch<Ban, any>({
        method: "GET",
    ...
    createGuildBan: (
      ...
      fetch<any, Partial<CreateGuildBanParams>>({
        method: "PUT",
        url: `/guilds/${guildId}/bans/${userId}`,
        params,
        options,
    ...
    removeGuildBan: (guildId: string, userId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/guilds/${guildId}/bans/${userId}`,
        options,
    ...
    getGuildRoles: (guildId: string, options?: O) =>
      fetch<Role[], any>({
        method: "GET",
    ...
    createGuildRole: (
      ...
      fetch<Role, Partial<CreateGuildRoleParams>>({
        method: "POST",
        url: `/guilds/${guildId}/roles`,
        params,
        options,
    ...
    modifyGuildRolePositions: (
      ...
      fetch<Role[], Partial<ModifyGuildRolePositionParams>>({
        method: "PATCH",
        url: `/guilds/${guildId}/roles`,
        params,
        options,
    ...
    modifyGuildRole: (
      ...
      fetch<Role, Partial<ModifyGuildRoleParams>>({
        method: "PATCH",
    ...
    deleteGuildRole: (guildId: string, roleId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/guilds/${guildId}/roles/${roleId}`,
        options,
    ...
    getGuildPruneCount: (
      ...
      fetch<any, Partial<GetGuildPruneCountParams>>({
        method: "GET",
    ...
    beginGuildPrune: (
      ...
      fetch<any, Partial<BeginGuildPruneParams>>({
        method: "POST",
        url: `/guilds/${guildId}/prune`,
        params,
        options,
    ...
    getGuildVoiceRegions: (guildId: string, options?: O) =>
      fetch<VoiceRegion[], any>({
        method: "GET",
    ...
    getGuildInvites: (guildId: string, options?: O) =>
      fetch<Invite[], any>({
        method: "GET",
    ...
    getGuildIntegrations: (guildId: string, options?: O) =>
      fetch<Integration[], any>({
        method: "GET",
    ...
    getGuildWidgetSettings: (guildId: string, options?: O) =>
      fetch<GuildWidget, any>({
        method: "GET",
    ...
    modifyGuildWidget: (guildId: string, options?: O) =>
      fetch<GuildWidget, any>({
        method: "PATCH",
        url: `/guilds/${guildId}/widget`,
        options,
    ...
    getGuildWidget: (guildId: string, options?: O) =>
      fetch<any, any>({
        method: "GET",
    ...
    getGuildVanityUrl: (guildId: string, options?: O) =>
      fetch<Invite, any>({
        method: "GET",
    ...
    getGuildWidgetImage: (
      ...
      fetch<any, Partial<GetGuildWidgetImageParams>>({
        method: "GET",
    ...
    getGuildWelcomeScreen: (guildId: string, options?: O) =>
      fetch<WelcomeScreen, any>({
        method: "GET",
    ...
    modifyGuildWelcomeScreen: (guildId: string, options?: O) =>
      fetch<WelcomeScreen, any>({
        method: "PATCH",
        url: `/guilds/${guildId}/welcome-screen`,
        options,
    ...
    updateCurrentUserVoiceState: (
      ...
      fetch<any, Partial<UpdateCurrentUserVoiceStateParams>>({
        method: "PATCH",
    ...
    updateUserVoiceState: (
      ...
      fetch<any, Partial<UpdateUserVoiceStateParams>>({
        method: "PATCH",
    ...
    modifyChannel: (
      ...
      fetch<Channel, Partial<ModifyChannelParams>>({
        method: "PATCH",
        url: `/channels/${channelId}`,
        params,
        options,
    ...
    deletecloseChannel: (channelId: string, options?: O) =>
      fetch<Channel, any>({
        method: "DELETE",
        url: `/channels/${channelId}`,
        options,
    ...
    getChannelMessages: (
      ...
      fetch<any, Partial<GetChannelMessageParams>>({
        method: "GET",
    ...
    getChannelMessage: (channelId: string, messageId: string, options?: O) =>
      fetch<any, any>({
        method: "GET",
    ...
    createMessage: (
      ...
      fetch<Message, Partial<CreateMessageParams>>({
        method: "POST",
        url: `/channels/${channelId}/messages`,
        params,
        options,
    ...
    crosspostMessage: (channelId: string, messageId: string, options?: O) =>
      fetch<Message, any>({
        method: "POST",
...
The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id. */
    getReactions: (
      ...
      fetch<User[], Partial<GetReactionParams>>({
        method: "GET",
    ...
    deleteAllReactions: (channelId: string, messageId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
...
The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id. */
    ...
    editMessage: (
      ...
      fetch<Message, Partial<EditMessageParams>>({
        method: "PATCH",
        url: `/channels/${channelId}/messages/${messageId}`,
        params,
        options,
    ...
    deleteMessage: (channelId: string, messageId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/channels/${channelId}/messages/${messageId}`,
        options,
    ...
    bulkDeleteMessages: (
      ...
      fetch<any, Partial<BulkDeleteMessageParams>>({
        method: "POST",
    ...
    editChannelPermissions: (
      ...
      fetch<any, Partial<EditChannelPermissionParams>>({
        method: "PUT",
    ...
    getChannelInvites: (channelId: string, options?: O) =>
      fetch<Invite[], any>({
        method: "GET",
    ...
    createChannelInvite: (
      ...
      fetch<Invite, Partial<CreateChannelInviteParams>>({
        method: "POST",
        url: `/channels/${channelId}/invites`,
        params,
        options,
    ...
    followNewsChannel: (
      ...
      fetch<FollowedChannel, Partial<FollowNewsChannelParams>>({
        method: "POST",
    ...
    triggerTypingIndicator: (channelId: string, options?: O) =>
      fetch<any, any>({
        method: "POST",
    ...
    getPinnedMessages: (channelId: string, options?: O) =>
      fetch<Message[], any>({
        method: "GET",
    ...
    pinMessage: (channelId: string, messageId: string, options?: O) =>
      fetch<any, any>({
        method: "PUT",
    ...
    unpinMessage: (channelId: string, messageId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/channels/${channelId}/pins/${messageId}`,
        options,
    ...
    groupDmAddRecipient: (
      ...
      fetch<any, Partial<GroupDmAddRecipientParams>>({
        method: "PUT",
    ...
    groupDmRemoveRecipient: (channelId: string, userId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/channels/${channelId}/recipients/${userId}`,
        options,
    ...
    startThreadWithMessage: (
      ...
      fetch<Channel, Partial<StartThreadWithMessageParams>>({
        method: "POST",
    ...
    startThreadWithoutMessage: (
      ...
      fetch<Channel, Partial<StartThreadWithoutMessageParams>>({
        method: "POST",
    ...
    joinThread: (channelId: string, options?: O) =>
      fetch<any, any>({
        method: "PUT",
    ...
    addThreadMember: (channelId: string, userId: string, options?: O) =>
      fetch<any, any>({
        method: "PUT",
    ...
    leaveThread: (channelId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/channels/${channelId}/thread-members/@me`,
        options,
    ...
    removeThreadMember: (channelId: string, userId: string, options?: O) =>
      fetch<any, any>({
        method: "DELETE",
        url: `/channels/${channelId}/thread-members/${userId}`,
        options,
    ...
    listThreadMembers: (channelId: string, options?: O) =>
      fetch<ThreadMember[], any>({
        method: "GET",
    ...
    listActiveThreads: (channelId: string, options?: O) =>
      fetch<any, any>({
        method: "GET",
    ...
    listPublicArchivedThreads: (
      ...
      fetch<any, Partial<ListPublicArchivedThreadParams>>({
        method: "GET",
    ...
    listPrivateArchivedThreads: (
      ...
      fetch<ChannelType, Partial<ListPrivateArchivedThreadParams>>({
        method: "GET",
    ...
    listJoinedPrivateArchivedThreads: (
      ...
      fetch<ChannelType, Partial<ListJoinedPrivateArchivedThreadParams>>({
        method: "GET",
